...
| Agent | Use when |
|---|---|
| [`architect`](.claude/agents/architect.md) | Plan non-trivial implementation |
| [`developer`](.claude/agents/developer.md) | Implement or fix code |
| [`reviewer`](.claude/agents/reviewer.md) | Review a diff and requirements |
| [`tester`](.claude/agents/tester.md) | Run offline validation |
| [`operator`](.claude/agents/operator.md) | Review env, runtime, sidecar, or deployment safety |

## Skills

| Skill | Use when |
|---|---|
| [`manager`](.claude/skills/manager/SKILL.md) | Mandatory repo-task orchestrator |
| [`nutrition-bot`](.claude/skills/nutrition-bot/SKILL.md) | Product behavior, config, services, storage, tests, or runtime |
| [`shallow-scoring`](.claude/skills/shallow-scoring/SKILL.md) | Score task complexity before manager routing |
| [`self-verify`](.claude/skills/self-verify/SKILL.md) | Final evidence check |
| [`flow-testing`](.claude/skills/flow-testing/SKILL.md) | Mandatory offline and live acceptance for every update |
